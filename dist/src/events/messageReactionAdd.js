...
exports.event = new Event_1.Event("messageReactionAdd", async (bot, reaction, user) => {
    try {
        ...
        // }
        const starboardMessage = await Guild_1.addStar(reaction.message.guild.id, reaction.message.id);
